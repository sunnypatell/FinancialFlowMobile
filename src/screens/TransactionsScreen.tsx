  ...
  useEffect(() => {
    loadData().then(data => {
      setUserData({
        ...
        chequingBalance: data.userData.chequingBalance || '',
        savingsBalance: data.userData.savingsBalance || '',
        monthlyIncome: data.userData.monthlyIncome || '',
        monthlyExpenses: data.userData.monthlyExpenses || '',
      });
    });
  }, []);
